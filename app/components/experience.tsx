...
export function Experience() {
  return (
    <div>
      ...
      <header className="z-10 mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2" aria-label="2022 to Present">2022 — Present</header>
      <div className="z-10 sm:col-span-6 mb-4">
        <h3 className="font-medium leading-snug text-slate-200">
          <div>
            <Link className="text-lg inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base" href="https://iheuron.com" target="_blank" rel="noreferrer noopener" aria-label="Software Engineer, Accessibility at Heuron">
...
기술 공유, 세미나를 통해 주니어 성장과 개발 문화 확산에도 적극 기여했습니다.</p>
      ...
      <header className="z-10 mb-2 mt-6 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2" aria-label="2020 to 2021">2020 — 2021</header>
      <div className="z-10 sm:col-span-6 mb-4">
        <h3 className="font-medium leading-snug text-slate-200">
          <div>
            <Link className="text-lg inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base" href="https://dktechin.com" target="_blank" rel="noreferrer noopener" aria-label="Software Engineer, Accessibility at DK Techin">
...
Helm 기반 쿠버네티스 배포, JaCoCo+SonarQube 환경 설정 등 DevOps와 코드 품질 개선도 주도했습니다.
      ...
      <header className="z-10 mb-2 mt-6 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2" aria-label="2016 to 2019">2016 — 2019</header>
      <div className="z-10 sm:col-span-6 mb-4">
        <h3 className="font-medium leading-snug text-slate-200">
          <div>
            <Link className="text-lg inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base" href="https://li-st.com" target="_blank" rel="noreferrer noopener" aria-label="Software Engineer, Accessibility at LiST">
